...
public final class Functional {
     ...
     */
    public static <T extends Object> String[] toStrings(T[] items) {
    ...
    public static float[] toFloatArray(CharSequence[] items) {
        ...
        for (int i = 0; i < items.length; ++i) {
            result[i] = items[i] == null ? Float.NaN : Float.valueOf(items[i].toString());
        }
        return result;
    }
    ...
    public static double[] toDoubleArray(CharSequence[] items) {
        ...
        for (int i = 0; i < items.length; ++i) {
            result[i] = items[i] == null ? Double.NaN : Double.valueOf(items[i].toString());
        }
        return result;
    }
